...
tf.app.flags.DEFINE_string('cityscapes_root',
                           '/home/deeplearning/anaconda2/envs/py27_tf/lib/python2.7/site-packages/tensorflow/models/research/deeplab/datasets/cityscapes',
                           'Cityscapes dataset root folder.')

tf.app.flags.DEFINE_string(
    'output_dir',
    '/home/deeplearning/anaconda2/envs/py27_tf/lib/python2.7/site-packages/tensorflow/models/research/deeplab/datasets/cityscapes/tf_two_class_test_2',
...
_POSTFIX_MAP = {
    'image': '_leftImg8bit',
    'label': '_gtFine_labelTrainIds_two_class',
}
...
def _get_files(data, dataset_split):
  ...
  search_files = os.path.join(
      FLAGS.cityscapes_root, "leftImg8bit" , dataset_split, '*', pattern)
  ...
  for shard_id in range(_NUM_SHARDS):
    ...
    with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
      ...
      for i in range(start_idx, end_idx):
        ...
        filename=image_files[i].split("/")[-1]
